ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :transactions, :collection => [:wsdl, :invoke] do |transaction|
  ...
  map.resources :messages, :except => :new, :requirements => { :id => /[0-9]+/ }, :collection => [:wsdl, :invoke] do |messages|
