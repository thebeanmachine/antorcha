...
describe OrganizationsController do
  ...
  describe "GET index" do
    it "assigns all organizations as @organizations" do
      Organization.stub(:find).with(:all).and_return([mock_organization])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested organization as @organization" do
      Organization.stub(:find).with("37").and_return(mock_organization)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new organization as @organization" do
      Organization.stub(:new).and_return(mock_organization)
      get :new
      assigns[:organization].should equal(mock_organization)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created organization as @organization" do
        Organization.stub(:new).with({'these' => 'params'}).and_return(mock_organization(:save => true))
