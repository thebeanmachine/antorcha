...
if Rails.env.production?
  Antorcha.organization "Huisarts test" do |lokaal|
    ...
    lokaal.fulfills "Adviseren" => [ "Therapeut" ]
    lokaal.fulfills "Huizenlijkgeweld" => [ "Huisarts" ]
  end
  ...
  Antorcha.organization "Consulent test" do |lokaal|
    ...
    lokaal.fulfills "Adviseren" => [ "Manager" ]
    lokaal.fulfills "Huizenlijkgeweld" => [ "Consulent" ]
  end
else
  Antorcha.organization "Lokale machine" do |lokaal|
    lokaal.destination_url "http://localhost:3000/messages"

    lokaal.fulfills "Adviseren" => [ "Therapeut", "Manager"]
    lokaal.fulfills "Huizenlijkgeweld" => [ "Huisarts", "Consulent" ]
  end
end
