class DefinitionReactionsController < ApplicationController
  load_and_authorize_resource :name => :reaction, :nested => :definition
  
  # GET /reactions
  # GET /reactions.xml
  def index
    @reactions = @definition.reactions.all
