#Requires Ruby version 1.8.5 or higher
require 'soap/wsdlDriver'

#Testen of SOAP werkt in de basis (uitvoer dient te beginnen met true) 
...
message = driver.Delete({:username=>"maarten",:password=>"asdfasdf"},{:step_id=>6,:body=>"My first WSDL created body",:transaction_id=>30,:title=>"Maarten test Soap voor Richard aan VIS2",:id=>lastMessageId})
puts message
